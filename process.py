...
# Preparing input and target sequences for training the model.
# The sequences are split into input and output sequences with a specified length of 100.
sequence_length = 100
...
# Determining the vocabulary size based on the unique words in the tokenizer.
